...
Pod::Spec.new do |s|
  s.name             = 'GDCpuModule'
  s.version          = '0.1.0'
  s.summary          = 'A short description of GDCpuModule.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/jelly130520@gmail.com/GDCpuModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'jelly130520@gmail.com' => 'guodong.zhang@vipshop.com' }
  s.source           = { :git => 'https://github.com/jelly130520@gmail.com/GDCpuModule.git', :tag => s.version.to_s }
